...
class SSCog(commands.Cog):
    def __init__(self, bot:commands.Bot):
        ...
        async def promote(interaction:discord.Interaction, user:discord.Member, role:discord.Role):
            ...
            else: return await interaction.followup.send(content=f"Unfortunately, I am unable to promote **{user.name}** to **{role.name}** because of my ***sufficient permissions***.")
        
        @promote.error
        async def _promote_error(interaction:discord.Interaction, error):
            return await interaction.followup.send(f"You are not allowed to promote because of your **sufficient permissions**.")
        ...
        async def _fire_error(interaction:discord.Interaction, error):
            return await interaction.followup.send(f"You are not allowed to fire because of your **sufficient permissions**.")
        ...
        async def _demote_error(interaction:discord.Interaction, error):
            return await interaction.followup.send(f"You are not allowed to demote because of your **sufficient permissions**.")
        ...
        async def raw_promote(ctx:commands.Context, user:discord.Member, role:discord.Role):
            ...
            else: return await default.edit(content=f"Unfortunately, I am unable to promote **{user.name}** to **{role.name}** because of my ***sufficient permissions***.")
        
        @raw_promote.error
        async def _raw_promote_error(ctx:commands.Context, error):
            return await ctx.send(f"You are not allowed to promote because of your **sufficient permissions**.")
        ...
        async def _raw_fire_error(ctx:commands.Context, error):
            return await ctx.send(f"You are not allowed to fire because of your **sufficient permissions**.")
        ...
        async def _raw_demote_error(ctx:commands.Context, error):
            return await ctx.send(f"You are not allowed to demote because of your **sufficient permissions**.")
